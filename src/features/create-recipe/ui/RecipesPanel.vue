        ...
        <li v-for="recipe in recipes" :key="recipe.id" class="recipe-item">
          ...
          <div class="recipe-controls">
            <div class="weight-add">
              <input
                v-model.number="recipeWeights[recipe.id]"
                type="number"
                min="1"
                placeholder="г"
                class="input-weight"
              ...
              <button
                class="btn-add"
                :disabled="!recipeWeights[recipe.id] || recipeWeights[recipe.id] <= 0"
                @click="addToDiary(recipe)"
